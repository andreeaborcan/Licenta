...
public class ModelWallUpComponent extends ModelComponent{
    ...
    public ModelWallUpComponent(Vector2f point1, Vector2f point2, int floor) {
        ...
        this.model = modelBuilder.createBox((float) (distance(point1,point2)),1f,(float)0.05,
                material, attributes);
        ...
        this.instance.transform.setTranslation((float)((point1.getX()+point2.getX())/2.0), 100f * floor +2.5f,(float)((point1.getY()+point2.getY())/2.0) );
    }
}
